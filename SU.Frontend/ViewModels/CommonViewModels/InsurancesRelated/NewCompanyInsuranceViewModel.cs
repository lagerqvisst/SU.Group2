...
public class NewCompanyInsuranceViewModel : ObservableObject
{
    ...
    public NewCompanyInsuranceViewModel(CompanyCustomerController companyCustomerController,
    ...
    private void FilterCompanyCustomers()
    {
        ...
        foreach (var customer in filteredList) FilteredCompanyCustomers.Add(customer);
    }
