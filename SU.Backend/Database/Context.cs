...
public class Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Insurance>()
            .HasMany(pi =>
                pi.InsuranceAddons) // An Insurance can have many InsuranceAddons (not limited to any type of insurnace)
        ...
        modelBuilder.Entity<Insurance>()
            ...
            .WithOne(ic =>
                ic.Insurance) // An InsuranceCoverage has one Insurance (this is a bridge to the differnt types of insurances)
        ...
        modelBuilder.Entity<Employee>()
            ...
            .OnDelete(DeleteBehavior
                .Restrict); // Prevent cascading deletion of Manager. If a Manager is deleted, the Employee will still exist.
        ...
        modelBuilder.Entity<PrivateCustomer>()
            ...
            .OnDelete(DeleteBehavior
                .Restrict); // Prevent deletion of PrivateCustomer if there are related InsurancePolicyHolders
        ...
        modelBuilder.Entity<CompanyCustomer>()
            ...
            .OnDelete(DeleteBehavior
                .Restrict); // Prevent deletion of CompanyCustomer if there are related InsurancePolicyHolders
        ...
        modelBuilder.Entity<InsuranceCoverage>()
            ...
            .HasForeignKey<
                PropertyAndInventoryCoverage>(pic => pic.InsuranceCoverageId) // FK in PropertyAndInventoryCoverage
            .OnDelete(DeleteBehavior
                .Cascade); // Delete the PropertyAndInventoryCoverage if the InsuranceCoverage is deleted
        ...
        modelBuilder.Entity<InsuranceCoverage>()
            ...
            .OnDelete(DeleteBehavior
                .Cascade); // Delete the VehicleInsuranceCoverage if the InsuranceCoverage is deleted
