...
public class InsuranceCreateService : IInsuranceCreateService
{
    ...
    ///     Many inputs are required to create a private insurance, such as a private customer, insurance type, coverage
    ///     option, seller, etc.
        ...
        InsuredPerson? insuredPerson = null)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Private insurance created successfully with total premium: {Premium}",
                insurance.Premium);
    ...
    public async Task<(bool success, string message)> CreatePropertyInventoryInsurance(
        ...
        PaymentPlan paymentPlan,
        DateTime? startDate =
            null, // Nullable startDate parameter, om man inte anger ett datum när försäkringen ska gälla, tas dagens datum.
        ...
        DateTime? endDate = null)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Company customer provided: {Org Nr} - {CompanyName}",
                companyCustomer.OrganizationNumber, companyCustomer.CompanyName);
        ...
        DateTime? endDate = null)
    {
        ...
        try
        {
            ...
            var insurance = new Insurance
            {
                ...
                Premium =
                    PremiumCalculator.GetVehicleInsurancePremium(riskZone, vehicleCoverage.VehicleInsuranceOption),
                Seller = seller
            };
            _logger.LogInformation("Insurance object created successfully.");
    ...
    public async Task<(bool success, string message)> DeleteInsurance(Insurance insurance)
    {
        ...
        catch (Exception ex)
        {
            ...
            return (false, $"An error occurred while deleting the insurance: {ex.Message}");
        }
    }
    ...
    public async Task<(bool success, string message)> UpdateInsurance(Insurance insurance)
    {
        ...
        {
            _logger.LogWarning(ex.ToString());
            return (false, $"An error occurred while updating the insurance: {ex.Message}");
        }
    }
}