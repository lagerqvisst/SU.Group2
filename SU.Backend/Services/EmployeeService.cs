...
public class EmployeeService : IEmployeeService
{
    ...
    public async Task<(bool success, string message)> UpdateEmployee(Employee employee)
    {
        ...
        catch (Exception e)
        {
            ...
            return (false, $"An error has occurred while updating the employee: {e.Message}");
        }
    }
    ...
    public async Task<(bool success, string message)> DeleteEmployee(Employee employee)
    {
        ...
        catch (Exception ex)
        {
            ...
            return (false, $"An error occurred while deleting the employee: {ex.Message}");
        }
    }
    ...
    public async Task<(bool success, string message, List<EmployeeRoleAssignment> employeeRoleAssignments)>
        GetAllEmployeeRoleAssignments()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Employee role assignments found: {EmployeeRoleAssignmentsCount}",
                employeeroleassignments.Result.Count);
        ...
        catch (Exception ex)
        {
            ...
            return (false, "An error occurred while fetching the employee role assignments.",
                new List<EmployeeRoleAssignment>());
        }
    }
    ...
    public async Task<(bool success, string message, Employee employee)> CreateNewEmployee(EmployeeType role,
        string firstName, string lastName, string personalNumber)
    {
        ...
        try
        {
            ...
            var employee = new Employee
            {
                ...
                UserName = EmployeeHelper.GenerateEmployeeUsername(firstName, lastName),
