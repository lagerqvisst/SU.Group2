...
public class EmployeeController
{
    ...
    public async Task<(bool success, string message, Employee employee)> CreateEmployee(EmployeeType role,
    ...
    public async Task<(List<EmployeeRoleAssignment> employeeRoleAssignments, string message)>
