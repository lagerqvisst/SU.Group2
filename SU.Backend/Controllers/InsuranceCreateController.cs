...
public class InsuranceCreateController
{
    ...
    // Constructor
    public InsuranceCreateController(IInsuranceCreateService insuranceCreateService,
        ILogger<InsuranceCreateController> logger)
    {
        ...
        InsuredPerson? insuredPerson = null)
    {
        ...
        var result = await _insuranceCreateService.CreatePrivateInsurance(privateCustomer, insuranceType,
        ...
        PaymentPlan paymentPlan)
    {
        ...
        var result = await _insuranceCreateService.CreatePropertyInventoryInsurance(companyCustomer,
            propertyAndInventoryCoverage, seller, note, paymentPlan);
        ...
        LiabilityCoverage liabilityCoverage, Employee seller, string note, PaymentPlan paymentPlan)
    {
        ...
        var result =
            await _insuranceCreateService.CreateLiabilityInsurance(companyCustomer, liabilityCoverage, seller, note,
                paymentPlan);
        ...
        PaymentPlan paymentPlan)
    {
        ...
        var result = await _insuranceCreateService.CreateVehicleInsurance(companyCustomer, vehicleCoverage, riskZone,
