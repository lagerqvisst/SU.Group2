...
namespace SU.Backend.Controllers
{
    ...
    public class StatisticsController
    {
        ...
        public async Task<(bool success, string message, SellerStatistics statistics)> SellerStatisticsBySeller(int year, Employee seller)
        {
        ...
        public async Task<(bool success, string message)> ExportTable(List<SellerStatistics> statistics, bool isPrivateInsurance)
        {
