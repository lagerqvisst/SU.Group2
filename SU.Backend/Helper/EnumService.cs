...
public static class EnumService
{
    ...
    ///     It was created to easily fetch information in the same way we do in our service classes but for enums which are are
    ///     not stored in the database.
    ///     You can see references in Viewmodels in the frontend project. Many of these enums are used in dropdowns /
    ///     comboboxes.
    /// </summary>
    /// <returns></returns>
